...
-- Exportiere Daten aus Tabelle airlimited.auftrag: ~7 rows (ungefähr)
DELETE FROM `auftrag`;
INSERT INTO `auftrag` (`AuftragsNr`, `Auftragsdatum`, `Status`, `Enddatum`, `FertigungsNr`, `SKUNr`, `Reihenfolge`) VALUES
	...
	(69, '2024-07-09 01:34:47', 'In Bearbeitung', '2024-07-09 01:35:08', 1, 13, 1),
	(70, '2024-07-09 15:09:59', 'In Bearbeitung', NULL, 9, 5, NULL),
	(71, '2024-07-09 23:16:51', 'In Bearbeitung', NULL, 8, 4, 1),
	(72, '2024-07-11 21:07:00', 'In Bearbeitung', NULL, 7, 2, 2),
	(73, '2024-07-12 00:14:08', 'In Bearbeitung', NULL, 5, 6, NULL),
	(76, '2024-07-15 09:19:58', 'Fertig', '2024-07-15 09:21:47', 5, 3, NULL);
...
-- Exportiere Daten aus Tabelle airlimited.bestellposten: ~19 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle airlimited.bestellung: ~18 rows (ungefähr)
...
INSERT INTO `bestellung` (`BestellNr`, `Bestelldatum`, `ServicepartnerNr`, `LagerNr`) VALUES
	...
	(134, '2024-07-12 00:13:34', 1, NULL),
	(135, '2024-07-12 00:14:08', 1, NULL),
	(136, '2024-07-12 00:14:08', NULL, 5),
	(140, '2024-07-15 09:19:58', 1, NULL),
	(141, '2024-07-15 09:19:58', NULL, 5);
...
-- Exportiere Daten aus Tabelle airlimited.gehoert_zu: ~10 rows (ungefähr)
...
INSERT INTO `servicepartner` (`ServicepartnerNr`, `Firmenname`, `Nachname Kontaktperson`, `Vorname Kontaktperson`, `Straße`, `HausNr`, `Stadt`, `PLZ`, `Land`, `TelefonNr`, `E-Mail`, `VIPKunde`, `Passwort`) VALUES
	...
	(7, 'Breeze Solutions GmbH', 'Becker', 'Sandra', 'Briseallee', 12, 'Köln', '56789', 'Deutschland', '+49 221 901234', 'sandro.becker@breeze-solutions.de', 'Nein', '$2y$10$FGmehw.PJi3wsVV5qU6vhe9w3.wL.NKHtNBQy6iQPKMOylPMWXWJ6'),
